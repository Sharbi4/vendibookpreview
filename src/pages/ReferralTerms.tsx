...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      "Selling or mass-distributing links is prohibited and will result in account suspension.",
      "Vendibook may suspend or terminate referral access for suspected fraud or abuse.",
      "Rewards are taxable income — 1099 issued for referrers earning $600+ in a calendar year. We collect W-9 information before payouts exceed $500 YTD.",
      ...
      "Payouts are batched weekly on Mondays with a $50 accumulated minimum.",
