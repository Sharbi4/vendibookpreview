 ...
 * Whole row is clickable when href is set; the `right` slot stays interactive.
 */
const PhotoListingCard = ({
  ...
  const inner = (
    <div className={cn(
      'flex items-center gap-3 sm:gap-4 p-3 sm:p-4 rounded-xl border border-border bg-card hover:bg-muted/30 transition-colors',
      className,
    )}>
      <div className="h-16 w-20 sm:h-20 sm:w-28 rounded-lg overflow-hidden bg-muted shrink-0 flex items-center justify-center">
        {imageUrl ? (
