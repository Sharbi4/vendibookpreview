...
const benefits = [
    ...
    description: "Launch and scale. Don't get locked into a 5-year loan. Whether you need a short-term rental to test a concept or a turnkey asset to own, we provide the inventory to scale on your terms."},
  {
    ...
    description: "Verified & Professional. We've standardized the industry. From verified identities to secure payment protection and digital agreements, we've handled the risk so you can focus on the food."},
  {
    icon: MapPin,
