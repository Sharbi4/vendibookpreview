...
const HelpCenterPreview = () => {
  return (
    <section className="py-16 md:py-20 relative overflow-hidden" aria-labelledby="help-center-heading">
      {/* GRADIENT Section - #FF5124 Orange based, subtle */}
      <div className="absolute inset-0 bg-gradient-to-br from-[#FF5124]/8 via-[#FF5124]/5 to-amber-200/4" />
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-10 left-1/4 w-72 h-72 bg-[#FF5124]/6 rounded-full blur-3xl" />
        <div className="absolute bottom-20 right-1/4 w-80 h-80 bg-[#FF5124]/5 rounded-full blur-3xl animate-pulse" />
        <div className="absolute top-1/2 right-10 w-64 h-64 bg-amber-300/4 rounded-full blur-3xl" />
      </div>
