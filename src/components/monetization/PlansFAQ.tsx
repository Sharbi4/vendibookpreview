...
const FAQ = [
  ...
  { q: 'How do the fees work?', a: 'We charge a 12.9% host commission and a 12.9% renter fee on rentals, and a 12.9% seller commission on card and PayPal sales. Cash equipment sales are 100% free. Active Vendibook Pro members pay a reduced 10.9% seller/host commission, with savings capped at $500 per completed transaction.' },
