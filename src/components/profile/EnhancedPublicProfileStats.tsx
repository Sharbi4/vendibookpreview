      ...
      {visibleItems.map((item, index) => {
        ...
        return (
          <motion.div
            ...
            className={cn(
              'relative overflow-hidden text-center p-4 md:p-5 rounded-2xl shadow-[0_8px_32px_-8px_rgba(0,0,0,0.15)] cursor-default',
              'bg-black/8 dark:bg-white/5 backdrop-blur-2xl',
