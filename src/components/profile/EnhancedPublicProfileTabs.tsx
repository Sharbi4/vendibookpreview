  ...
  return (
    ...
    >
      <Tabs defaultValue="listings" className="w-full">
        <TabsList className="w-full grid grid-cols-2 mb-6 p-1.5 h-auto bg-card/80 backdrop-blur-2xl rounded-2xl sticky top-0 z-10 border border-border/60 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.3)]">
          {tabs.map((tab, index) => {
            const Icon = tab.icon;
            return (
              <TabsTrigger
