...
const StorefrontStickyContact = ({
  ...
  return (
    ...
    >
      ...
      <div className="relative bg-card/90 backdrop-blur-2xl border-t border-border/60 rounded-t-2xl shadow-[0_-8px_30px_-8px_rgba(0,0,0,0.3)]">
        ...
        <div className="relative flex gap-2 px-4 py-3 max-w-lg mx-auto">
          ...
          <Button 
            ...
            className="flex-1 h-11 rounded-xl font-medium bg-secondary text-foreground border border-border/60 hover:bg-accent transition-all"
          >
          ...
          <Button
            onClick={onShare}
            size="icon"
            className="h-11 w-11 rounded-xl bg-secondary text-foreground border border-border/60 hover:bg-accent transition-all flex-shrink-0"
          >
