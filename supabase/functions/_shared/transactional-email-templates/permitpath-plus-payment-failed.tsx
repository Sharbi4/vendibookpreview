    ...
    <Body style={l.main}>
      <Container style={l.container}>
        ...
        <Section style={l.card}>
          ...
          <Hr style={l.hr} />
          <Text style={l.small}>
            Your subscription hasn&apos;t been cancelled. PayPal will retry automatically, and your
...
export const template = {
  ...
  subject: (d: Record<string, any>) =>
    `Action needed: ${d?.planName ?? 'PermitPath Plus'} payment didn't go through`,
  displayName: 'PermitPath Plus — payment failed',
  previewData: { firstName: 'Alex', planName: 'PermitPath Plus', amount: '$7.99', accessThrough: 'October 19, 2026' },
