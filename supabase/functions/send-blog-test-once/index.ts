...
<tr><td style="padding:28px 32px 8px 32px;"><img src="${LOGO_IMG}" alt="Vendibook" height="36" style="height:36px;display:block;border:0;"></td></tr>
<tr><td style="padding:16px 24px 0 24px;"><img src="${HERO_IMG}" alt="The New Exit Plan" width="552" style="width:100%;height:auto;border-radius:12px;display:block;border:0;"></td></tr>
