...
BEGIN
  ...
  RETURN jsonb_build_object(
    ...
    -- Only shared when routing is live and the seller is fully ready; PayPal
    -- requires the payee merchant id in the browser SDK for routed checkout.
    'merchant_id', CASE WHEN _gating AND _ready THEN _row.merchant_id ELSE NULL END
  );
END;
$function$;